...
DT=tree.DecisionTreeClassifier(max_depth=100,random_state=1)
...
#Logistic regression
class_weight={0:0.5,1:0.35}
from sklearn.linear_model import LogisticRegression
from sklearn import linear_model
LR = linear_model.LogisticRegression(class_weight = class_weight)
